...
\begin{beamercolorbox}[wd=\paperwidth,sep=18pt]{headline}
  \begin{minipage}[c]{0.165\paperwidth}
    ...
    \usebox0\hspace{8pt}%
    \raisebox{\dimexpr-0.2\ht0-1.2\dp0\relax}{\includegraphics[height=\dimexpr1.4\ht0+1.4\dp0\relax]{figures/oa_tree.png}}%
  \end{minipage}\hfill
  \begin{minipage}[c]{0.72\paperwidth}
    \centering
    {\Huge\bfseries MarinSpin: Can a Transformer Learn Coarsening Dynamics?}\\[10pt]
  ...
  \begin{minipage}[c]{0.10\paperwidth}
    \centering
    \includegraphics[width=0.78\linewidth]{figures/qr_marinspin.png}\\[2pt]
    {\footnotesize\color{ink}\textbf{MarinSpin Repo}}
  \end{minipage}
\end{beamercolorbox}
